  ...
  return (
    ...
    >
      <section className="max-w-2xl">
        <h2 className="text-[#FFA500] text-lg mt-[3rem]">
          International Legal Assistance
        </h2>

        <h2 className="text-3xl font-semibold text-white my-[1rem]">
          International Legal Solutions for Individuals and Businesses
        </h2>

        <p className="text-xl">
          We offer structured, end-to-end cross-border legal support, enabling
          efficient representation across jurisdictions while minimizing the
          need for travel.
        </p>
      ...
      <section className="max-w-2xl w-full">
        <div className="grid grid-cols-2 gap-4 mt-6 w-full">
          ...
          <button className="w-full border border-[#FFA500] shadow-[0_0_10px_2px_rgba(244,196,48,0.3)] text-[#F7E7CE] px-6 py-3 rounded-md hover:bg-[#5F021F] transition">
            Estate, Asset and Succession Advisory
          </button>
