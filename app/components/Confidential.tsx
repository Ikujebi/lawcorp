...
export default function Footer() {
  return (
    ...
    <Image width={800} height={400} src={rect} alt="International Legal Assistance" className="w-[35rem] "/>
</section>
      
      <section className="max-w-2xl">
        
        <h2 className="text-[#FFA500] text-lg mt-[3rem] text-center">Confidential Legal Support</h2>
        
       
     
     <p className="text-xl">We provide an initial consultation to understand your legal concern and guide you on the appropriate course of action. This is a safe and confidential space — not legal solicitation or advice.</p>
