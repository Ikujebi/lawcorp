...
const CoreV = () => {
  ...
  return (
    <section >
     <h2 className={` text-lg font-thin tracking-wide mb-4 text-gray-800`}>Our Core Values</h2>
      <h2 className="2xl:text-[4rem] text-[2.5rem]  font-semibold mb-4">Principles That Define Our Legal Practice</h2>
      <p className="max-w-3xl text-[1.363rem]  text-gray-700 mb-4">
