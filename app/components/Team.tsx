...
>
          <h2 className={` text-lg font-thin tracking-wide mb-4 text-gray-800`}>Our Legal Team</h2>
          <h2 className="2xl:text-[4rem] text-[2.5rem]  font-semibold mb-4">Experienced Advocates You Can Trust</h2>
          <p className="max-w-3xl text-[1.363rem] text-center text-gray-700 mb-4">
            Our team consists of experienced advocates
             with deep courtroom exposure and subject-matter
              expertise across civil,
             criminal, family, and NRI legal matters.
          </p>
          ...
          {values.map(({ title, description, icon: Icon }) => (
            ...
            >
              ...
              <div className="mb-4 flex   items-center justify-center rounded-full border border-[#F4C430]/5">
                <Image src={Icon} alt={title} className=" w-[10rem] h-[8rem] object-cover text-gray-900 rounded-[50%] group-hover:text-[#F4C430] transition-colors duration-300" />
              </div>
